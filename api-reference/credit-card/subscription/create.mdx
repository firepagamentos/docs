...
<ParamField body="basicValue.valuePerMonth" type="integer" required>
  Valor mensal em centavos (sempre especificar mensal mesmo para trimestral/anual)
</ParamField>
...
### Assinaturas Mensais
- **Básico**: R$ 29,99/mês = `valuePerMonth: 2999`
- **Adicional**: R$ 5,00/mês configuração = `value: 500`
- **Total**: R$ 34,99/mês

### Assinaturas Trimestrais
- **Básico**: R$ 149,99 a cada 3 meses = `valuePerMonth: 4999` (cobrado como R$ 149,97)
- **Cobrança**: Cobrado a cada 3 meses na data de início

### Assinaturas Anuais
- **Básico**: R$ 999,99 por ano = `valuePerMonth: 8333` (cobrado como R$ 999,96)
