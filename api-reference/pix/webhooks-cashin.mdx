...
curl -X POST "https://api-gateway.firebanking.com.br/v2/webhooks" \
...
### Webhook de Teste
```bash
curl -X POST "https://api-gateway.firebanking.com.br/v2/webhooks/test" \
  -H "x-api-key: fbk_live_sua_chave_aqui" \
  -H "Content-Type: application/json" \
  -d '{
    "event": "pix.payment_received",
...
curl -X GET "https://api-gateway.firebanking.com.br/v2/webhooks/logs?pix_id=pix_12345678901234567890" \
  -H "x-api-key: fbk_live_sua_chave_aqui"
```
