---
title: 'Fluxo de Integração - Boleto'
description: 'Guia completo do fluxo de integração para processar boletos bancários'
---
...
<Frame>
  <img
    ...
    src="/images/bank-slip-flow.png"
    alt="Fluxo de Integração - Boleto"
  />
  <img
    className="hidden dark:block"
    src="/images/bank-slip-flow-dark.png"
    alt="Fluxo de Integração - Boleto"
  />
</Frame>
...
```bash cURL
curl --request POST \
  --url https://api-gateway.firebanking.com.br/v1/bank-slip \
...
const response = await fetch('https://api-gateway.firebanking.com.br/v1/bank-slip', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api-gateway.firebanking.com.br/v1/bank-slip',
    headers={
        'x-api-key': 'sua_chave_api',
        'Content-Type': 'application/json'
    },
