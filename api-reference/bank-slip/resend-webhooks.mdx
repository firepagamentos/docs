...
```bash cURL
curl -X POST https://api-gateway.firebanking.com.br/bank-slip/v1/payments/webhooks/resend \
...
const response = await fetch('https://api-gateway.firebanking.com.br/bank-slip/v1/payments/webhooks/resend', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api-gateway.firebanking.com.br/bank-slip/v1/payments/webhooks/resend',
    headers={
        'Content-Type': 'application/json',
        'x-api-key': 'YOUR_API_KEY'
    },
