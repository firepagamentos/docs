...
openapi: 'POST /bank-slip/v1/payments/webhooks/resend'
...
```bash cURL
curl -X POST https://api.firebanking.com.br/bank-slip/v1/payments/webhooks/resend \
...
const response = await fetch('https://api.firebanking.com.br/bank-slip/v1/payments/webhooks/resend', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.firebanking.com.br/bank-slip/v1/payments/webhooks/resend',
    headers={
        'Content-Type': 'application/json',
        'x-api-key': 'YOUR_API_KEY'
    },
...
<Warning>
**Importante**: O endpoint não garante entrega. Se o webhook URL do business estiver indisponível, a requisição falhará.
</Warning>
