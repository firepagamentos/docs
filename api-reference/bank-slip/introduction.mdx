...
<CardGroup cols={2}>
  <Card title="Criar Boleto" icon="plus" href="/api-reference/bank-slip/create">
    Aprenda a emitir seu primeiro boleto
  </Card>
  <Card title="Consultar Status" icon="eye" href="/api-reference/bank-slip/get">
