...
curl -X GET "https://api-gateway.firebanking.com.br/v1/payment/bol_1234567890123456" \
  -H "x-api-key: fbk_live_sua_chave_aqui"
```

```bash cURL - Por External ID
curl -X GET "https://api-gateway.firebanking.com.br/v1/payment/pedido-123?type=external" \
  -H "x-api-key: fbk_live_sua_chave_aqui"
```

```javascript JavaScript
// Consultar por ID interno
const response = await fetch('https://api-gateway.firebanking.com.br/v1/payment/bol_1234567890123456', {
  headers: {
...
const responseExternal = await fetch('https://api-gateway.firebanking.com.br/v1/payment/pedido-123?type=external', {
  headers: {
    'x-api-key': 'fbk_live_sua_chave_aqui'
  }
});
...
response = requests.get(
    'https://api-gateway.firebanking.com.br/v1/payment/bol_1234567890123456',
...
response_external = requests.get(
    'https://api-gateway.firebanking.com.br/v1/payment/pedido-123',
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://api-gateway.firebanking.com.br/v1/payment/bol_1234567890123456',
...
// Por external_id
curl_setopt($curl, CURLOPT_URL, 'https://api-gateway.firebanking.com.br/v1/payment/pedido-123?type=external');
