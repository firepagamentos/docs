...
4. Bloqueia saldo necessário
   ↓
5. Executa pagamento na Celcoin
   ↓
...
<AccordionGroup>
  <Accordion title="Saldo insuficiente">
    ...
    ```
    O business não possui saldo disponível suficiente para o pagamento. A mensagem indica o saldo disponível e o valor necessário.
  </Accordion>
...
3. **Execução**: Pagamento é processado na Celcoin
...
**Erro Imediato (falha na Celcoin)**:
