...
Retorna uma lista paginada de todos os pagamentos de boletos realizados pelo business, com suporte a filtros avançados por status, data inicial e data final.
...
```bash cURL
curl -X GET "https://api.firebanking.com.br/bank-slip/v1/payments/withdraws?page=1&limit=20" \
...
```bash cURL
curl -X GET "https://api.firebanking.com.br/bank-slip/v1/payments/withdraws?status=PAID" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash cURL
curl -X GET "https://api.firebanking.com.br/bank-slip/v1/payments/withdraws?startDate=2024-01-01&endDate=2024-01-31" \
  -H "x-api-key: YOUR_API_KEY"
```
...
```bash cURL
curl -X GET "https://api.firebanking.com.br/bank-slip/v1/payments/withdraws?page=1&limit=10&status=PAID&startDate=2024-01-01" \
  -H "x-api-key: YOUR_API_KEY"
```
...
const response = await fetch(`https://api.firebanking.com.br/bank-slip/v1/payments/withdraws?${params}`, {
  headers: {
...
response = requests.get(
    'https://api.firebanking.com.br/bank-slip/v1/payments/withdraws',
    params=params,
    headers={
        'x-api-key': 'YOUR_API_KEY'
    }
