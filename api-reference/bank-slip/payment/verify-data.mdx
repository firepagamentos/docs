...
```bash cURL
curl -X POST https://api-gateway.firebanking.com.br/bank-slip/v1/payments/withdraw/verify-data \
...
const response = await fetch('https://api-gateway.firebanking.com.br/bank-slip/v1/payments/withdraw/verify-data', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api-gateway.firebanking.com.br/bank-slip/v1/payments/withdraw/verify-data',
    headers={
        'Content-Type': 'application/json',
        'x-api-key': 'YOUR_API_KEY'
    },
