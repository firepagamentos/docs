...
curl -X PATCH "https://api-gateway.firebanking.com.br/bank-slip/v1/payment/bol_1234567890123456/cancel" \
...
curl -X PATCH "https://api-gateway.firebanking.com.br/bank-slip/v1/payment/pedido-123/cancel?type=external" \
  -H "x-api-key: fbk_live_sua_chave_aqui" \
  -H "Content-Type: application/json" \
  -d '{
