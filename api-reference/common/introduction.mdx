...
<CardGroup cols={2}>
  ...
  <Card title="Webhooks" icon="bell" href="/api-reference/webhooks/configure">
    Configure notificações em tempo real
  </Card>
  <Card title="Retry Webhooks" icon="arrow-rotate-right" href="/api-reference/webhooks/retry">
...
<CardGroup cols={2}>
  ...
  <Card title="Configurar Webhooks" icon="bell" href="/api-reference/webhooks/configure">
