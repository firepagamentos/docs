...
<AccordionGroup>
  ...
  <Accordion title="📱 PIX">
    ...
    **Taxa média:** R$ 0,50 - R$ 2,00 por transação
  </Accordion>
  ...
  <Accordion title="🏦 Boleto Bancário">
    ...
    **Taxa média:** R$ 1,50 - R$ 3,00 por boleto
  </Accordion>
</AccordionGroup>

## Tabela Comparativa

| Aspecto | Cartão de Crédito | PIX | Boleto |
|---------|------------------|-----|--------|
| **Tempo de confirmação** | Instantâneo | Instantâneo | 1-3 dias úteis |
| **Disponibilidade** | 24h/7 dias | 24h/7 dias | Horário bancário |
| **Taxa** | % do valor | Fixa | Fixa |
| **Valor mínimo** | R$ 1,00 | R$ 1,00 | R$ 10,00 |
| **Valor máximo** | R$ 50.000 | R$ 100.000 | R$ 100.000 |
| **Parcelamento** | ✅ Até 12x | ❌ À vista | ❌ À vista |
| **Assinaturas** | ✅ Sim | ❌ Não | ❌ Não |
| **Estorno** | ✅ Automático | ✅ Manual | ❌ Não disponível |
...
```json Configuração Recomendada
{
  ...
  "rules": {
    "high_value": ["pix", "credit_card", "bank_slip"],
    "low_value": ["credit_card", "pix"],
    "corporate": ["pix", "bank_slip", "credit_card"]
  }
}
```
...
<CardGroup cols={2}>
  ...
  <Card title="⚙️ Integração Completa" icon="cogs" href="/guides/integration-flow">
