...
const response = await fetch('https://api-gateway.firebanking.dev/pix/v2/charge/qrcode', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api-gateway.firebanking.dev/pix/v2/charge/qrcode',
    json=pix_data,
    headers={
        'x-api-key': 'fbk_test_SUA_CHAVE_AQUI',
        'Content-Type': 'application/json'
...
<CodeGroup>
```bash cURL - Chave PIX
curl -X POST "https://api-gateway.firebanking.dev/pix/v2/charge/key" \\
  -H "x-api-key: fbk_test_SUA_CHAVE_AQUI" \\
  -H "Content-Type: application/json" \\
  -d '{
    "amount": 250.00,
...
curl -X GET "https://api-gateway.firebanking.dev/pix/v2/charge/pix_charge_abc123" \\
  -H "x-api-key: fbk_test_SUA_CHAVE_AQUI"
```

```bash cURL - Consulta por External ID
curl -X GET "https://api-gateway.firebanking.dev/pix/v2/charge?externalId=pix-qr-001" \\
  -H "x-api-key: fbk_test_SUA_CHAVE_AQUI"
```
</CodeGroup>
...
curl -X POST "https://api-gateway.firebanking.dev/pix/v2/withdraw" \\
  -H "x-api-key: fbk_test_SUA_CHAVE_AQUI" \\
  -H "Content-Type: application/json" \\
  -d '{
    "amount": 150.75,
...
curl -X POST "https://api-gateway.firebanking.dev/pix/v2/charge/pix_charge_abc123/simulate-payment" \\
  -H "x-api-key: fbk_test_SUA_CHAVE_AQUI" \\
  -H "Content-Type: application/json" \\
  -d '{
    "payer": {
